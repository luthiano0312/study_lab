...
<body class="bg-white text-gray-700 h-screen w-screen overflow-hidden font-sans">
    ...
    {<div id="step1"
        ...
        <div class="flex-1 flex flex-col items-start justify-center w-full max-w-lg px-10">
            ...
            <div
                class="w-full flex items-center gap-2 px-3.5 py-2 bg-gray-50 border border-gray-100 rounded-md text-[12px] text-gray-400">
        ...
        <div class="w-full px-11 pb-8 flex items-center justify-between flex-shrink-0">
            ...
            <x-ob-btn id="nextStep1" :step="2" label="PROXIMO" disabled />
        </div>
    </div>
    ...
    <div id="step4"
        ...
        <div class="flex-1 flex flex-col items-center justify-center w-full max-w-lg px-10 text-center">
            ...
            <div id="cardPreview" class="w-full rounded-xl overflow-hidden p-3.5 relative transition-all duration-500"
                ...
                <div id="cardPatternOverlay" class="absolute inset-0 opacity-5"
                ...
                <div class="relative flex items-center gap-3">
                    <div id="previewPhotoMini"
                        class="w-9 h-11 rounded-lg border-2 border-white/25 bg-white/15 overflow-hidden flex-shrink-0 flex items-center justify-center">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div id="previewSchool" class="text-[7.5px] text-white/50 mt-0.5">STUDYLAB ACADEMY · GRADUAÇÃO
                        </div>
                        <div id="previewId" class="text-[7px] text-white/30 mt-1">SL-000001</div>
                    </div>
                    <div id="previewYear"
                        class="text-[8px] font-black text-white/60 bg-white/15 px-2 py-0.5 rounded flex-shrink-0">
                        {{ date('Y') }}</div>
                </div>
            </div>
        </div>
