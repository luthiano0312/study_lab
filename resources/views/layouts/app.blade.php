    ...
    <div class="flex flex-col h-screen">
        ...
        <header class="bg-white h-20 px-8 flex items-center justify-between border-b border-pink-500 shadow-sm z-50">
            ...
            <div class="flex items-center gap-6">
                ...
                <button
                    class="relative w-10 h-10 rounded-xl hover:bg-gray-100 flex items-center justify-center transition">
                    <img class="h-5 opacity-70"
                        src="{{ asset('favicons/notifications_24dp_00000_FILL0_wght400_GRAD0_opsz24.png') }}">

                    <span
                        class="absolute -top-1 -right-1 bg-pink-600 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                        #
                    </span>
                </button>

                <div
                    class="flex items-center gap-3 bg-gray-50 px-3 py-2 rounded-xl hover:bg-gray-100 transition cursor-pointer">
                    <img src="" class="w-9 h-9 rounded-full object-cover">
...
{{ request()->is('dashboard') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
...
{{ request()->is('subject*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                            ...
                            <a href="/horary"
                                class="flex items-center gap-3 px-4 py-2 rounded-xl transition
{{ request()->is('horary*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                                <img class="h-4 opacity-60"
                            ...
                            <a href="/notes"
                                class="flex items-center gap-3 px-4 py-2 rounded-xl transition
{{ request()->is('notes*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                                <img class="h-4 opacity-60"
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="#"
                                class="flex items-center gap-3 px-4 py-2 rounded-xl transition
{{ request()->is('boletim*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                                <img class="h-4 opacity-60"
                            ...
                            <a href="#"
                                class="flex items-center gap-3 px-4 py-2 rounded-xl transition
{{ request()->is('progresso*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                                <img class="h-4 opacity-60"
                    ...
                    <div>
                        ...
                        <a href="/profile"
                            class="flex items-center gap-3 px-4 py-2 rounded-xl transition
{{ request()->is('profile*') ? 'bg-pink-50 text-pink-600 shadow-sm' : 'hover:bg-pink-50 hover:text-pink-600' }}">
                            <img class="h-4 opacity-60"
