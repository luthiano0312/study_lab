...
@section('content')
  ...
  <div class="min-h-screen relative overflow-hidden bg-[#f4f7fd] dark:bg-[#121212] transition-colors duration-200">
    ...
    <div class="relative z-10 max-w-2xl mx-auto px-6 py-10">
      ...
      <div class="mb-8">
        ...
        <p class="text-xs font-extrabold tracking-widest uppercase text-pink-400 mb-1">Novo trabalho</p>
        <h1 class="text-4xl font-black text-gray-900 dark:text-gray-100 leading-tight">Cadastrar Trabalho</h1>
        ...
        <form id="examForm" class="px-8 py-7 flex flex-col gap-5" novalidate>
          ...
          <div class="flex justify-end gap-2.5">
            ...
            <button type="submit" id="submitBtn"
              ...
              <span id="btnLabel">Salvar trabalho</span>
            </button>
          </div>
  ...
  {{-- Toast --}}
  <div class="hidden z-50 fixed bottom-6 right-6 bg-white dark:bg-[#18181b] border border-gray-200 dark:border-gray-800 border-l-[3px] border-l-pink-600 rounded-xl shadow-xl px-5 py-3.5 items-center gap-3"
    id="toast">
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4338ca" stroke-width="2.5" stroke-linecap="round"
      stroke-linejoin="round">
      <polyline points="20 6 9 17 4 12"/>
    </svg>
    <div>
      <p class="text-gray-800 dark:text-gray-100 font-bold text-sm">Trabalho cadastrado!</p>
