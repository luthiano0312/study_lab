...
@section('content')
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 py-10">
            ...
            <div class="flex flex-wrap items-end justify-between gap-4 mb-8 fade-up">
                <div>
                    ...
                    <h1 class="font-black text-gray-900 dark:text-gray-100 leading-tight text-4xl" style="font-family:'Syne',sans-serif;">
            ...
            <div class="flex flex-wrap gap-3 mb-6 fade-up" style="animation-delay:.1s">
                <div
                    class="bg-white/80 dark:bg-[#18181b]/80 backdrop-blur-sm rounded-2xl px-4 py-3 shadow-sm dark:shadow-none border border-pink-100 dark:border-gray-800 flex items-center gap-3 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-black text-gray-900 dark:text-white leading-none" id="statTotal"
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-lg font-black text-gray-900 dark:text-white leading-none" id="statPending"
                            style="font-family:'Syne',sans-serif;">—</p>
                    </div>
                </div>
                <div
                    ...
                    <div>
                        ...
                        <p class="text-lg font-black text-gray-900 dark:text-white leading-none" id="statProgress"
                            style="font-family:'Syne',sans-serif;">—</p>
                    </div>
                </div>
                <div
                    ...
                    <div>
                        ...
                        <p class="text-lg font-black text-gray-900 dark:text-white leading-none" id="statDone"
                            style="font-family:'Syne',sans-serif;">—</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white/90 dark:bg-[#18181b]/95 backdrop-blur-sm rounded-3xl shadow-xl shadow-pink-100 dark:shadow-none overflow-hidden border border-pink-100 dark:border-gray-800 fade-up transition-colors duration-200"
                ...
                <div class="px-6 pt-5 pb-3 flex items-center justify-between border-b border-pink-50 dark:border-gray-800">
                    <div class="flex items-center gap-3">
                        <button id="prevWeek"
                            class="w-9 h-9 rounded-xl bg-pink-50 dark:bg-pink-900/20 hover:bg-pink-100 dark:hover:bg-pink-900/40 flex items-center justify-center text-pink-600 dark:text-pink-400 transition-colors cursor-pointer">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="3" stroke-linecap="round">
                                <path d="M15 18l-6-6 6-6" />
                            </svg>
                        </button>
                        <span id="weekLabel" class="text-sm font-black text-gray-800 dark:text-gray-100"
                    ...
                    <button id="todayBtn"
                        class="text-[11px] font-black uppercase tracking-wider text-pink-600 dark:text-pink-400 bg-pink-50 dark:bg-pink-900/20 hover:bg-pink-100 dark:hover:bg-pink-900/40 px-4 py-1.5 rounded-xl transition-colors cursor-pointer">Hoje</button>
                </div>
                ...
                <div class="px-6 py-3 bg-pink-50/50 dark:bg-pink-900/5 border-t border-pink-100 dark:border-gray-800 flex items-center justify-between">
    ...
    <div id="examModal" class="hidden fixed inset-0 bg-black/30 backdrop-blur-sm z-50 items-center justify-center p-4">
        <div class="bg-white dark:bg-[#18181b] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-transparent dark:border-gray-800">
            <div class="h-1 bg-linear-to-r from-pink-600 to-pink-400"></div>
            <div class="p-6">

                <div class="flex items-center justify-between mb-5">
                    <h2 id="modalTitle" class="text-base font-black text-gray-900 dark:text-gray-100"
                ...
                <div class="mb-4">
                    <label class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-1.5">Tipo de
                        prova</label>
                    <select id="modalType"
                        class="w-full border border-gray-200 dark:border-gray-800 rounded-xl px-3 py-2.5 text-sm font-semibold text-gray-800 dark:text-gray-100 bg-gray-50 dark:bg-[#18181b] focus:outline-none focus:border-pink-400 focus:bg-white dark:focus:bg-[#18181b] transition-colors appearance-none"
                ...
                <div class="mb-4 hidden" id="typeCustomWrap">
                    ...
                    <input id="typeCustom" type="text"
                        class="w-full border border-gray-200 dark:border-gray-800 rounded-xl px-3 py-2.5 text-sm font-semibold text-gray-800 dark:text-gray-100 bg-gray-50 dark:bg-[#18181b] focus:outline-none focus:border-pink-400 focus:bg-white dark:focus:bg-[#18181b] transition-colors"
                ...
                <div class="mb-4">
                    ...
                    <input id="descCustom" type="text"
                        class="hidden w-full mt-2 border border-gray-200 dark:border-gray-800 rounded-xl px-3 py-2.5 text-sm font-semibold text-gray-800 dark:text-gray-100 bg-gray-50 dark:bg-[#18181b] focus:outline-none focus:border-pink-400 focus:bg-white dark:focus:bg-[#18181b] transition-colors"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button id="modalSave"
                        class="flex items-center gap-1.5 bg-pink-600 hover:bg-pink-700 disabled:opacity-60 text-white text-[11px] font-black px-5 py-2.5 rounded-xl transition-all shadow-sm shadow-pink-200 dark:shadow-none cursor-pointer">
    ...
    <div id="toast"
        ...
        <p class="text-gray-800 dark:text-gray-100 font-bold text-sm" id="toastMsg">Pronto!</p>
    </div>
