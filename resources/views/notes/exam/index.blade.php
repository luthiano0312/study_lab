...
<div class="min-h-full" style="font-family:'DM Sans',sans-serif;">
  ...
  <div class="flex items-end justify-between mb-6">
    <div>
      ...
      <h1 class="font-black text-gray-900 leading-tight text-3xl" style="font-family:'Syne',sans-serif;">Calendário de Provas</h1>
      <p class="text-sm text-gray-400 font-semibold mt-0.5">Visualize, adicione e edite suas provas semana a semana</p>
    </div>
  </div>
  ...
  <div class="flex flex-wrap gap-3 mb-6">
    ...
    <div class="flex items-center gap-3 bg-white border border-pink-100 rounded-2xl px-4 py-3">
      ...
      <div>
        ...
        <p class="text-lg font-black text-gray-900 leading-none" id="statTotal" style="font-family:'Syne',sans-serif;">—</p>
      </div>
    </div>
    ...
    <div class="flex items-center gap-3 bg-white border border-pink-100 rounded-2xl px-4 py-3">
      ...
      <div>
        ...
        <p class="text-lg font-black text-gray-900 leading-none" id="statPending" style="font-family:'Syne',sans-serif;">—</p>
      </div>
    </div>
    ...
    <div class="flex items-center gap-3 bg-white border border-pink-100 rounded-2xl px-4 py-3">
      ...
      <div>
        ...
        <p class="text-lg font-black text-gray-900 leading-none" id="statProgress" style="font-family:'Syne',sans-serif;">—</p>
      </div>
    </div>
    ...
    <div class="flex items-center gap-3 bg-white border border-pink-100 rounded-2xl px-4 py-3">
      ...
      <div>
        ...
        <p class="text-lg font-black text-gray-900 leading-none" id="statDone" style="font-family:'Syne',sans-serif;">—</p>
      </div>
    </div>
  ...
  <div class="bg-white rounded-3xl border border-pink-100 shadow-sm overflow-hidden">
    ...
    <div class="px-6 pt-5 pb-3 flex items-center justify-between border-b border-pink-50">
      <div class="flex items-center gap-3">
        ...
        <span id="weekLabel" class="text-sm font-black text-gray-800" style="font-family:'Syne',sans-serif;"></span>
        <button id="nextWeek"
                class="w-9 h-9 rounded-xl bg-pink-50 hover:bg-pink-100 flex items-center justify-center text-pink-600 transition-colors cursor-pointer">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round">
    ...
    <div class="overflow-x-auto">
      <table class="w-full border-collapse" style="table-layout:fixed;">
        ...
        <tbody><tr id="calBody"></tr></tbody>
      </table>
    </div>

   
    <div class="px-6 py-3 bg-pink-50/40 border-t border-pink-100 flex items-center justify-between">
      <p class="text-[10px] font-bold text-gray-400 uppercase tracking-wider">StudyLab • Calendário de Provas</p>
  ...
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
    ...
    <div class="p-6">
      ...
      <div class="flex items-center justify-between mb-5">
        <h2 id="modalTitle" class="text-base font-black text-gray-900" style="font-family:'Syne',sans-serif;">Nova prova</h2>
      ...
      <div class="mb-4 bg-pink-50 rounded-xl px-4 py-2.5 flex items-center gap-2.5">
        ...
        <span id="modalDateLabel" class="text-sm font-black text-pink-700" style="font-family:'Syne',sans-serif;"></span>
        <input type="hidden" id="modalDate">
        <input type="hidden" id="modalExamId">
      </div>

      <div class="mb-4">
        <label class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-1.5" for="modalType">
          Tipo de prova
        </label>
        <select id="modalType"
      ...
      <div class="mb-4 hidden" id="typeCustomWrap">
        <label class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-1.5" for="typeCustom">
          Tipo personalizado
        </label>
      ...
      <div class="mb-4">
        <label class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-1.5" for="modalDesc">
          Matéria
        </label>
        <div class="relative">
          <select id="modalDesc"
          ...
          <div class="pointer-events-none absolute inset-y-0 right-3 flex items-center">
            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
        </div>
      ...
      <div class="mb-4">
        <label class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-1.5" for="modalTime">
...
<div id="toast"
     ...
     style="display:none;">
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#db2777" stroke-width="2.5" stroke-linecap="round">
    <path d="M20 6L9 17l-5-5"/>
  </svg>
