...
@section('content')
    ...
    <div class="min-h-screen relative h-full w-full  bg-[#fdf4f8]" style="font-family:'Inter',sans-serif;">
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-6 py-10">
            ...
            <div class="mb-8 fade-up">
                ...
                <p class="text-xs font-extrabold tracking-widest uppercase text-pink-400 mb-1">Editar prova</p>
                <h1 class="text-4xl font-black text-gray-900 leading-tight">Editar Prova</h1>
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl shadow-pink-100 overflow-hidden border border-pink-100 fade-up"
                ...
                <form id="examForm" class="px-8 py-7 flex flex-col gap-5" novalidate data-id="{{ $exam->id }}"
                    data-type="{{ $exam->type }}" data-description="{{ $exam->description }}"
                    data-due_date="{{ $exam->due_date }}" data-status="{{ $exam->status }}">
                    ...
                    <div>
                        ...
                        <div id="extra-type" class="hidden mt-2">
                            <input type="text" id="type_custom" placeholder="Digite o tipo de prova"
                                class="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-sm text-gray-900 bg-white outline-none transition placeholder-gray-400 focus:border-pink-500 focus:ring-2 focus:ring-pink-100">
                        </div>
                        <p id="err-type" class="hidden text-xs font-medium text-red-500 mt-1">Selecione ou informe o
                            tipo.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p id="err-description" class="hidden text-xs font-medium text-red-500 mt-1">Informe uma
                            descrição.</p>
                    </div>
    ...
    <div class="fixed inset-0 bg-black/35 backdrop-blur-sm hidden items-center justify-center z-50" id="deleteModal"
        style="display:none;">
    ...
    <div id="toast"
        class="fixed bottom-6 right-6 items-center gap-3 bg-white border border-gray-100 border-l-4 border-l-pink-500 rounded-xl shadow-lg px-5 py-3.5 z-50"
        style="display:none;">
        ...
        <div>
            <p class="text-gray-800 font-bold text-sm">Prova atualizada!</p>
