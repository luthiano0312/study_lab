...
@section('content')
    <div class="min-h-screen relative overflow-hidden bg-[#fdf4f8]" style="font-family:'DM Sans',sans-serif;">
        ...
        <div class="absolute top-32 right-12 float-b pointer-events-none opacity-65"><svg width="70" height="70"
                viewBox="0 0 70 70" fill="none">
                <rect x="6" y="40" width="58" height="18" rx="4" fill="#db2777" />
                <rect x="6" y="40" width="8" height="18" rx="3" fill="#be185d" />
                <rect x="16" y="45" width="24" height="3" rx="2" fill="#fce7f3" opacity=".6" />
                <rect x="10" y="24" width="50" height="18" rx="4" fill="#fbbf24" />
                <rect x="10" y="24" width="8" height="18" rx="3" fill="#d97706" />
                <rect x="20" y="30" width="20" height="3" rx="2" fill="#fff" opacity=".5" />
                <rect x="4" y="8" width="62" height="18" rx="4" fill="#06b6d4" />
                <rect x="4" y="8" width="8" height="18" rx="3" fill="#0891b2" />
                <rect x="14" y="14" width="22" height="3" rx="2" fill="#fff" opacity=".5" />
            </svg></div>
        <div class="absolute top-44 left-1/3 float-c pointer-events-none" style="animation-delay:.8s"><svg width="22"
                height="22" viewBox="0 0 22 22" fill="none">
                <path d="M11 1L12.8 8.2L20 10L12.8 11.8L11 19L9.2 11.8L2 10L9.2 8.2Z" fill="#f472b6" opacity=".65" />
            </svg></div>
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-6 py-10">
            <div class="mb-8 fade-up">
                ...
                <p class="text-[10px] font-black tracking-widest uppercase text-pink-400 mb-1">Nova matéria</p>
                <h1 class="text-4xl font-black text-gray-900 leading-tight" style="font-family:'Syne',sans-serif;">
                    Cadastrar Matéria</h1>
            ...
            <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl shadow-pink-100 overflow-hidden border border-pink-100 fade-up"
                ...
                <form id="subjectForm" class="px-8 py-7 flex flex-col gap-5" novalidate>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Matéria <span
                                class="text-pink-500">*</span></label>
                        <select id="name" name="name"
                            class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-800 bg-white focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-100 transition-colors cursor-pointer appearance-none"
                        ...
                        <div id="extra-name" class="hidden mt-2">
                            <input type="text" id="name_custom" placeholder="Digite o nome da matéria"
                                class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-800 bg-white focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-100 transition-colors placeholder:text-gray-400">
                        </div>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Código <span
                                class="text-pink-500">*</span></label>
                        ...
                        <div id="extra-abbreviation" class="hidden mt-2">
                            <input type="text" id="abbreviation_custom" placeholder="Ex: MAT201"
                                class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm font-medium text-gray-800 bg-white uppercase focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-100 transition-colors placeholder:text-gray-400">
                        </div>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Professor <span
                                class="text-pink-500">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-1.5">Semestre <span
                                class="text-pink-500">*</span></label>
    ...
    <div id="toast"
        ...
        <div>
            <p class="text-gray-800 font-bold text-sm">Matéria cadastrada!</p>
