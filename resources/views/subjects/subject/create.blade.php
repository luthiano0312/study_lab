...
@section('content')
            ...
            <div class="bg-white/90 dark:bg-[#18181b]/95 backdrop-blur-sm rounded-3xl shadow-xl shadow-pink-100 dark:shadow-none overflow-hidden border border-pink-100 dark:border-gray-800 fade-up transition-colors duration-200"
                ...
                <form id="subjectForm" class="px-8 py-7 flex flex-col gap-5" novalidate>
                    ...
                    <div class="flex justify-end gap-2.5">
                        <a href="/subjects"
                            class="inline-flex items-center gap-1.5 border border-pink-200 dark:border-gray-700 hover:border-pink-300 dark:hover:border-gray-600 text-pink-500 dark:text-gray-300 font-bold text-sm px-5 py-2.5 rounded-xl transition-colors">Cancelar</a>
    ...
    <div id="toast"
        ...
        <div>
            <p class="text-gray-800 dark:text-gray-100 font-bold text-sm">Matéria cadastrada!</p>
