...
@section('content')
    <div class="min-h-screen relative overflow-hidden bg-[#fdf4f8]" style="font-family:'DM Sans',sans-serif;">
        ...
        <div class="relative z-10 max-w-2xl mx-auto px-6 py-10">
            <div class="mb-8 fade-up">
                ...
                <h1 class="text-4xl font-black text-gray-900 leading-tight" style="font-family:'Syne',sans-serif;">Editar
                    Matéria</h1>
                ...
                <form id="subjectForm" class="px-8 py-7 flex flex-col gap-5" novalidate data-id="{{ $subject->id }}"
                    ...
                    <div class="flex items-center justify-between">
                        <button type="button" id="deleteBtn"
                            class="inline-flex items-center gap-1.5 text-red-400 hover:text-red-600 border border-red-100 hover:border-red-300 hover:bg-red-50 font-bold text-sm px-4 py-2.5 rounded-xl transition-all">
    ...
    <div id="toast"
        ...
        <div>
            <p class="text-gray-800 font-bold text-sm">Matéria atualizada!</p>
