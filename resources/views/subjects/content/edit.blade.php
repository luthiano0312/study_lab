...
@section('content')
                ...
                <form id="contentForm" class="px-8 py-7 flex flex-col gap-5" novalidate data-id="{{ $content->id }}"
                    ...
                    <div class="flex items-center justify-between gap-2">
                        <button type="button" id="deleteBtn"
                            class="inline-flex items-center gap-1.5 border border-red-200 hover:bg-red-50 text-red-500 font-bold text-sm px-4 py-2.5 rounded-xl transition-colors">
    ...
    <div id="toast"
        ...
        <div>
            <p class="text-gray-800 font-bold text-sm">Conteúdo atualizado!</p>
