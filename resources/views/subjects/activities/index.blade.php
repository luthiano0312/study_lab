...
@section('content')
    ...
    <div class="hidden fixed bottom-6 right-6 bg-white border border-gray-200 border-l-[3px] border-l-pink-600 rounded-xl shadow-xl px-5 py-3.5 flex items-center gap-3 z-50"
        id="toast">
