...
@section('content')
        ...
        <form id="activityForm" class="px-8 py-7 flex flex-col gap-5" novalidate>
          ...
          <div>
            ...
            <select id="due_date_quick"
              ...
              /%3E%3C/svg%3E\");background-repeat:no-repeat;background-position:right 12px center;padding-right:2.2rem;">
  ...
  <div
    class="hidden z-50 fixed bottom-6 right-6 bg-white dark:bg-[#18181b] border border-gray-200 dark:border-gray-800 border-l-[3px] border-l-pink-600 rounded-xl shadow-xl px-5 py-3.5 items-center gap-3"
    id="toast">
