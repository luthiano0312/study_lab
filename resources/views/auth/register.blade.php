        ...
        <div class="w-[320px]">
            ...
            <form id="registerForm" class="space-y-3">
                ...
                <div class="space-y-1">
                    ...
                    <input id="name" type="text" class="input-field text-sm" placeholder="Estudante123" required>
                ...
                <div class="space-y-1">
                    ...
                    <input id="email" type="email" class="input-field text-sm" placeholder="estudante@gmail.com"
                        required>
                ...
                <div class="space-y-1">
                    ...
                    <input id="phone" type="text" class="input-field text-sm" placeholder="(88) 99999-9999">
                    <p class="error-text hidden" id="error-phone"></p>
                </div>

                <div class="space-y-1">
                    <label class="text-xs text-gray-500">Senha</label>
                    <input id="password" type="password" class="input-field text-sm" placeholder="********" required>
                    <p class="error-text hidden" id="error-password"></p>
                </div>

                <div class="space-y-1">
                    <label class="text-xs text-gray-500">Confirmar Senha</label>
                    <input id="password_confirmation" type="password" class="input-field text-sm" placeholder="********"
                        required>
                    <p class="error-text hidden" id="error-password_confirmation"></p>
                </div>

                <button type="submit" class="w-full mt-3 bg-[#FF0073] text-white py-2.5 text-sm rounded-full 
