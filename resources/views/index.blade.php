...
<body class="overflow-x-hidden m-0  font-family: 'Figtree', sans-serif ">
  ...
  <header class="fixed top-0 left-0 w-full bg-white h-20 shadow-[0_6px_15px_rgba(0,0,0,0.15)] z-50">
    <div class="flex justify-between items-center h-full px-32">
      ...
      <div>
        <img src="{{ asset('images/Logosemfundo.png') }}" 
             class="w-20" 
             alt="Logo">
      </div>
      ...
      <div class="flex items-center gap-6">
        <a href="#"
           class="text-[#FF0073] px-4 py-1.5 rounded-md font-medium
                  transition duration-500 ease-out
                  hover:bg-[#FF0073] hover:text-white">
          Entrar
        </a>

        <a href="#"
           class="bg-[#FF0073] px-4 py-1.5 flex items-center justify-center
  ...
  <section class="h-screen pt-20 flex items-center justify-center bg-white z-10">
    <div class="flex justify-between gap-[200px]">
      <div class="mt-[60px] ">
        <h1 class="font-bold text-[95px] leading-none pl-[50px]">
          <b>Bem vindo a <br>
          <span class="text-[#FF0073]">Studylab</b></span>
        </h1>
      ...
      <div>
        <img class="w-[550px]" 
             src="{{asset('images/session1image.png')}}" 
             alt="">
      </div>
    </div>
  </section>
  ...
  <div class="max-w-[1200px] w-full px-6">
    ...
    <div class="grid grid-cols-3 gap-10">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-[0_6px_15px_rgba(0,0,0,0.12)] hover:-translate-y-2 transition duration-300">
...
<section class="h-screen flex items-center justify-center bg-[#f5f5f5] z-40">
...
<section class="h-screen flex flex-col justify-between bg-[#f2f2f2] z-50">
  ...
  <div class="flex-1 flex flex-col items-center justify-center text-center px-6">
    ...
    <button class="mt-6 bg-[#F40D75] hover:bg-[#d10c65] 
