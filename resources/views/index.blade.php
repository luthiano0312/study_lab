...
<body class="overflow-x-hidden m-0 font-family: 'Figtree', sans-serif">
        ...
        <div class="flex justify-between items-center h-full px-32">
            ...
            <div class="flex items-center gap-6">
               <a href="/login" class="text-[#FF0073] px-4 py-1.5 rounded-md font-medium border border-transparent transition-all duration-300 ease-in-out hover:border-[#FF0073]">
                ...
                <a href="/register"
                    class="bg-[#FF0073] px-4 py-1.5 flex items-center justify-center font-medium text-white rounded-md transition duration-300 ease-in hover:bg-[#d10c65]">
                    Criar conta
                </a>
            </div>
        </div>
    ...
    <section
        class="reveal opacity-0 translate-y-10 transition-all duration-700 h-screen pt-20 flex items-center justify-center bg-white z-10">
    ...
    <section class="h-screen flex items-center justify-center bg-[#f5f5f5] z-20">
        <div class="max-w-[1200px] w-full px-6">
            ...
            <div class="grid grid-cols-3 gap-10">
                ...
                <div
                    class="reveal opacity-0 translate-y-10 transition-all duration-700 bg-white rounded-2xl p-6 shadow-[0_6px_15px_rgba(0,0,0,0.12)] hover:-translate-y-2">
    ...
    <section class="h-screen flex flex-col justify-between bg-[#f2f2f2] z-50">
        <div class="flex-1 flex flex-col items-center justify-center text-center px-6">
            ...
            <a href="/register"
                class="mt-6 bg-[#F40D75] hover:bg-[#d10c65] text-white px-8 py-3 rounded-lg font-semibold transition duration-300">Criar
                conta</a>
